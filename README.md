...
- plans.csv - Información de planes actuales
Precio mensual, minutos incluidos, GB incluidos, Costos por excesos (mensajes, minutos, datos)

- users_latam.csv - Información de clientes (4,000 registros)
...
- usage.csv - Detalle de uso real de servicios (40,000 registros)
Llamadas y mensajes por usuario, Duración de llamadas y longitud de mensajes
...
Análisis de oportunidades de upselling, Identificación de segmentos valiosos, Recomendaciones estratégicas
